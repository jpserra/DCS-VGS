...
public class Simulation implements Runnable {
	...
	public Simulation() {
		...
		gs1 = new GridScheduler( 0, nEntities, nJobs, "localhost", startingPort, false);
		gs2 = new GridScheduler( 1, nEntities, nJobs, "localhost", startingPort+1, "localhost", 50000, false);
